...
rewards_90 = stat_rewards(rewards, lambda l: np.percentile(l, 100))
rewards_75 = stat_rewards(rewards, lambda l: np.percentile(l, 90))
rewards_25 = stat_rewards(rewards, lambda l: np.percentile(l, 70))
rewards_10 = stat_rewards(rewards, lambda l: np.percentile(l, 50))
...
fig.savefig('./p_pole_final_10.svg', format='svg', dpi=1200)
fig.savefig('./p_pole_final_10.pdf', format='pdf')
